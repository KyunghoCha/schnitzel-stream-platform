# Legacy Docs (Quarantined)

Last updated: 2026-02-15

## English

This folder contains **legacy-only** documentation preserved for:
- v1 job graph compatibility (Phase 0 indirection)
- migration reference and parity verification

These docs are **not** the platform core SSOT.
...
이 폴더는 다음 목적을 위해 **레거시 전용** 문서를 보존합니다.

- v1 job 그래프 호환(Phase 0 우회)
- 마이그레이션 참고/패리티 검증

이 문서들은 **플랫폼 코어 SSOT**가 아닙니다.
