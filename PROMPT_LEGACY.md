# Handoff Prompt (Legacy CCTV Pipeline, Archived)

Last updated: 2026-02-15

> Archived: This prompt describes the legacy CCTV pipeline era and is kept for historical reference.
> Current SSOT: `PROMPT.md`, `PROMPT_CORE.md`, `docs/roadmap/execution_roadmap.md`.
>
> 보관 문서: 레거시 CCTV 파이프라인 시기의 프롬프트이며, 역사적 참고용입니다.
> 현재 SSOT: `PROMPT.md`, `PROMPT_CORE.md`, `docs/roadmap/execution_roadmap.md`.
