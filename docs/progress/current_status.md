...
- Execution SSOT current step id: `P15.1` (UX preset onboarding track)
...
- P15 UX preset onboarding track started (`P15.1`: one-command preset UX lane)
...
- 실행 SSOT current step id: `P15.1` (UX 프리셋 온보딩 트랙)
...
- P15 UX 프리셋 온보딩 트랙 시작(`P15.1`: 원커맨드 프리셋 UX 레인)
