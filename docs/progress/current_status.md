...
- Execution SSOT current step id: `P18.8` (onboarding UX + one-command local console bootstrap docs-sync closure)
...
- 실행 SSOT current step id: `P18.8` (온보딩 UX + 원커맨드 로컬 콘솔 부트스트랩 문서 동기화 마감)
