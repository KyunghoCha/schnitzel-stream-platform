# 노드 그래프 가이드 (노드 카탈로그 + 교체 규칙)

Last updated: 2026-02-16

## English

This guide explains node graph fundamentals, node catalog, and replacement rules.
...
- 그래프는 `nodes`(노드 목록)와 `edges`(연결 목록)로 구성됩니다.
...
YAML에서 `nodes[].kind`는 다음 중 하나입니다.
...
그래프: `configs/graphs/dev_inproc_demo.yaml`
...
그래프: `configs/graphs/dev_vision_e2e_mock.yaml`
...
그래프: `configs/graphs/dev_rtsp_frames.yaml`
...
- enqueue: `configs/graphs/dev_durable_enqueue.yaml`
- drain: `configs/graphs/dev_durable_drain.yaml`
- drain+ack: `configs/graphs/dev_durable_drain_ack.yaml`
...
그래프: `configs/graphs/dev_http_event_sink.yaml`
...
- JSONL: `configs/graphs/dev_jsonl_sink.yaml`
- JSON 파일: `configs/graphs/dev_json_file_sink.yaml`
