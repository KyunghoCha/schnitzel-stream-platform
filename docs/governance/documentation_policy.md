...
| Archive | Historical record only | No functional guarantees; do not use as SSOT | git history/tag (example: `pre-legacy-purge-20260216`) |
...
3. move obsolete docs out of active set and preserve via git history/tag
...
| Archive | 역사 기록 | 기능 보장 없음, SSOT로 사용 금지 | git 이력/태그 (예: `pre-legacy-purge-20260216`) |
...
3. 오래된 문서는 active 세트에서 제외하고 git 이력/태그로 보존
