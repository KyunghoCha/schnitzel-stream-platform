...
This folder contains active implementation documentation for the runtime.
...
Historical CCTV/legacy implementation notes are not kept in the working tree.
...
역사적 CCTV/레거시 구현 노트는 워킹 트리에 두지 않는다.
