...
- Utility tooling: `scripts/check_rtsp.py`, `scripts/regression_check.py`, `scripts/multi_cam.py`
...
- 유틸리티 도구: `scripts/check_rtsp.py`, `scripts/regression_check.py`, `scripts/multi_cam.py`
