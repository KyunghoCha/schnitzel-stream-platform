...
Current step id (SSOT): `P25.1` (see `docs/roadmap/execution_roadmap.md`)
...
- plugin DX closure phase opened (`P25.1`, scaffold/contract/CI hardening lane)
...
- 플러그인 DX 마감 페이즈 오픈(`P25.1`, 스캐폴드/계약검사/CI 하드닝 레인 시작)
